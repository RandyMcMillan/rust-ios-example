...
class RecipeCollectionsViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: RecipeCollectionsViewController.reuseIdentifier) as! RecipeCollectionRowCell
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        if let destination = navController.topViewController as? RecipeDetailViewController {
...
class RecipeCollectionRowCell: UITableViewCell, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    var recipeCollectionViewController: RecipeCollectionsViewController?
    var recipes: [Recipe]?
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        ...
        if let cell = cell as? RecipeListCell {
